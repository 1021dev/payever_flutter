...
///
/// To integrate the [CustomPlacesAutocompleteField] into a [Form] with other [FormField]
...
class CustomPlacesAutocompleteField extends StatefulWidget {
  ...
  /// notifier to check if the value changes
...
class _LocationAutocompleteFieldState
    extends State<CustomPlacesAutocompleteField> {
  ...
  @override
  void didUpdateWidget(CustomPlacesAutocompleteField oldWidget) {
  ...
  void _handleTap() async {
    ...
    setState(
      () {
        // street
        // print(
        //     "p.structuredFormatting mainText => ${p.structuredFormatting.mainText}");
        // //
        // print("p.placeId => ${p.placeId}");
        // print("p.structuredFormatting => ${p.structuredFormatting}");
        // print(
        //     "p.structuredFormatting secondaryText => ${p.structuredFormatting.secondaryText}");
        // print("p.terms ");
        // p.terms.forEach(
        //   (t) {
        //     print(t.value);
