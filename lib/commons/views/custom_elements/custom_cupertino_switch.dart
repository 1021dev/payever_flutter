...
/// {@tool sample}
///
/// This sample shows how to use a [CustomCupertinoSwitch] in a [ListTile]. The
...
class _CustomCupertinoSwitchState extends State<CustomCupertinoSwitch> with TickerProviderStateMixin {
  @override
...
const double _kTrackHeight = 24.2;
const double _kTrackRadius = _kTrackHeight / 0.9;
const double _kTrackInnerStart = _kTrackHeight / 3.0;
const double _kTrackInnerEnd = _kTrackWidth - (_kTrackInnerStart);
const double _kTrackInnerLength = _kTrackInnerEnd - _kTrackInnerStart;
const double _kSwitchWidth = 46.02;
const double _kSwitchHeight = 30.42;
// Opacity of a disabled switch, as eye-balled from iOS Simulator on Mac.
const double _kCupertinoSwitchDisabledOpacity = 0.5;

// Color _kTrackColor = Colors.black.withOpacity(0.2);
const Color _kTrackColor = Color(0x36000000);
...
class _RenderCupertinoSwitch extends RenderConstrainedBox {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final Rect trackRect = Rect.fromLTWH(
        offset.dx + (size.width - _kTrackWidth) / 2.5,
        offset.dy + (size.height - _kTrackHeight) / 3.5,
        _kTrackWidth+5,
        _kTrackHeight+4,
    );
    ...
    final double thumbCenterY = offset.dy + size.height / 2;

    final Rect thumbBounds = Rect.fromLTRB(
      thumbLeft + (visualPosition == 1 ?(2):10),
      thumbCenterY - (CupertinoThumbPainter.radius -4),
      thumbRight +(visualPosition == 1?(-4):(4)),
      thumbCenterY + (CupertinoThumbPainter.radius-2),
    );
