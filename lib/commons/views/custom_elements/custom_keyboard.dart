...
class NumberKeyboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool tablet = portrait ? mediaQuery.size.width>600:mediaQuery.size.height>600;
    return Material(
      color: Colors.red,
      child: DefaultTextStyle(
          ...
          child: Container(
            padding: tablet &&!portrait?EdgeInsets.symmetric(horizontal: mediaQuery.size.width*0.15):EdgeInsets.zero,
            ...
            child: GridView.count(
                ...
                childAspectRatio: (tablet && !portrait? 5:2) / (tablet && !portrait? 2:1),
                mainAxisSpacing: 0.5,
  ...
  Widget buildButton(num title, {String value}) {
    if (value == null) {
      value = "$title";
    }
    return Container(
