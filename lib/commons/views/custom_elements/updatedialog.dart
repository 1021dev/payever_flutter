...
/// ***
///
/// Controller that will cut the access in case a mandatory update is needed for the app,
/// it will keep the app in a dialog to close or to redirect to the respective store to
...
class VersionController {
  ...
  Future<Version> getSupportedVersion() async {
    ...
    Env.map(environment);
    return RestDataSource().getVersion().then(
      (_version) {
