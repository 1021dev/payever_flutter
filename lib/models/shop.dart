...
class Shop{
  ...
  Shop.toMap(dynamic obj){
    ...
    _channelSet =  obj[GlobalUtils.DB_SHOP_CHANNELSET];
    _createdAt =  obj[GlobalUtils.DB_SHOP_CREATEDAT];
    _defaultLocale =  obj[GlobalUtils.DB_SHOP_DEFAULTLOCALE];
    ...
    _updatedAt =  obj[GlobalUtils.DB_SHOP_UPDATEDAT];
