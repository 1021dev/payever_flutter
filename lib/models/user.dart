...
class User {
  ...
  User(this._createdAt,this._email,this._firstName,
      this._language ,this._lastName ,this._updatedAt,
      this._id,this._salutation,this._phone,this._logo,this._brithday);
  ...
  User.map(dynamic obj) {
    ...
    this._updatedAt  = obj[GlobalUtils.DB_USER_UPDATEDAT];
    this._createdAt  = obj[GlobalUtils.DB_USER_CREATEDAT];
    ...
    this._brithday   = obj[GlobalUtils.DB_USER_BIRTHDAY];
  ...
  Map<String, dynamic> toMap() {
    ...
    map[GlobalUtils.DB_USER_UPDATEDAT]  = _updatedAt;
    map[GlobalUtils.DB_USER_CREATEDAT]  = _createdAt;
    map[GlobalUtils.DB_USER_EMAIL]      = _email;
    map[GlobalUtils.DB_USER_SALUTATION] = _salutation;    
    map[GlobalUtils.DB_USER_PHONE]      = _phone;    
    map[GlobalUtils.DB_USER_BIRTHDAY]   = _brithday;    
