...
class SquarePicker extends StatefulWidget {
  ...
  @override
  _SquarePickerState createState() => _SquarePickerState();
}
...
class SquareItem extends StatelessWidget {
  ...
  final String value;
  final String name;
  SquareItem({this.index, this.onChangeSelection, this.value, this.name});
  bool selected;
  bool justUnderLine = true;
  Color sFrameColor = Colors.blueAccent;
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      child: Padding(
        ...
        child: Container(
          /// 15 to keep same padding as in the entire POS
          ...
          decoration: BoxDecoration(
            ...
            border: Border(
              top: BorderSide(
                width: frameWidth,
                color: selected ? sFrameColor : frameColor,
              ),
              bottom: BorderSide(
                width: frameWidth,
                color: selected ? sFrameColor : frameColor,
...
class SquareName extends StatelessWidget {
  final Color color;
  final num size;

  SquareName({@required this.color, @required this.size});
