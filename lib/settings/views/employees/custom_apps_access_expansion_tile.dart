...
import '../../../commons/views/custom_elements/custom_expansion_tile.dart';
...
//  int _activeIndex;
  ...
  List<Widget> businessAppsHeaderWidgetList = List<Widget>();
  List<Widget> businessAppsBodyWidgetList = List<Widget>();

  @override
  void initState() {
    super.initState();

    widget.employeesStateModel.businessApps.asMap().forEach((i, app) {
      businessAppsHeaderWidgetList.add(
        Container(
          child: Row(
            children: <Widget>[
              CachedNetworkImage(
                imageUrl: uiKit + app.dashboardInfo.icon,
              ),
              SizedBox(width: 10),
              Text(Language.getCommerceOSStrings(app.dashboardInfo.title),
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
      ...
      businessAppsBodyWidgetList.add(Expanded(
        child: Container(
...
//              right: Measurements.width * 0.040),
            ...
            child: Column(
              children: <Widget>[
                Container(
                  child: app.allowedAcls.create != null
                      ? Row(
...
//                                value: appIndex.allowedAcls.read,
                            ...
                            onChanged: (bool value) {
                              setState(() {
                                widget.employeesStateModel
                                    .updateBusinessAppPermissionRead(i, value);
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: CustomExpansionTile(
        ...
        widgetsTitleList: businessAppsHeaderWidgetList,
        widgetsBodyList: businessAppsBodyWidgetList,
      ),
    );
...
//                                  CachedNetworkImage(
//                                    imageUrl:
//                                        uiKit + appIndex.dashboardInfo.icon,
//                                  ),
//                                  SizedBox(width: 10),
//                                  Text(
