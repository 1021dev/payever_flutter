...
class ExternalDomainScreen extends StatefulWidget {

  final ShopScreenBloc screenBloc;
  final String businessId;
  final ShopDetailModel detailModel;

  ExternalDomainScreen({
    this.screenBloc,
    this.businessId,
    this.detailModel,
  });
  ...
  @override
  createState() => _ExternalDomainScreenState();
}

class _ExternalDomainScreenState extends State<ExternalDomainScreen> {
  ...
  void initState() {
    if (widget.detailModel.accessConfig.internalDomain != null) {
      domainTextController.text = widget.detailModel.accessConfig.ownDomain;
    }
    super.initState();
  }
                ...
                child: SizedBox.expand(
                  child: MaterialButton(
                    onPressed: buttonEnabled ? () async {
                      ...
                      config.ownDomain = domainTextController.text;
