...
class ProductsSoldCard extends StatefulWidget {
  @override
  createState() => _ProductsSoldCardState();
}

class _ProductsSoldCardState extends State<ProductsSoldCard> {
