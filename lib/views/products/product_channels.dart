...
class ProductChannelsRow extends StatefulWidget {
  ...
  @override
  _ProductChannelsRowState createState() => _ProductChannelsRowState();
}
          ...
          children: <Widget>[
            ...
            widget.parts.havePOS? Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Text(Language.getWidgetStrings("widgets.pos.title"),style: TextStyle(fontSize: AppStyle.fontSizeDashboardTitle()))
                ],)
              ,)
              :Container(),
            widget.parts.havePOS? Container(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Text(widget.parts.terminals[index].name,style: TextStyle(fontSize: AppStyle.fontSizeTabContent())),
                              Switch(
            ...
            widget.parts.haveShop? Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: <Widget>[
                  SvgPicture.asset("images/shopicon.svg", height: AppStyle.iconTabSize(widget.parts.isTablet),),
                  Padding(padding: EdgeInsets.only(right: Measurements.width * 0.02),),
                  Text(Language.getWidgetStrings("widgets.store.title"),style: TextStyle(fontSize: AppStyle.fontSizeTabTitle()))
                ],)
              ,)
              :Container(),
            widget.parts.haveShop? Container(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            Text(widget.parts.shops[index].name,style: TextStyle(fontSize: AppStyle.fontSizeTabContent())),
                            Switch(
                              activeColor: widget.parts.switchColor,
                              value: shopEnabled,
                              onChanged: (bool value) {
