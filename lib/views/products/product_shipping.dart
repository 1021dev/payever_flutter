...
class _ProductShippingRowState extends State<ProductShippingRow> {
  ...
  void initState() {
    super.initState();
     //if(widget.parts.editMode){
      widget.parts.product.shipping.free    = widget.parts.product.shipping.free??false;
      widget.parts.product.shipping.general = widget.parts.product.shipping.general??false;
    //}
  }
  ...
  Widget build(BuildContext context) {
    ...
    wlh = <Widget>[
      widget.parts.isTablet?Expanded(
        child: width):width,
                  ...
                  children: <Widget>[
                    Container(
                      padding: EdgeInsets.symmetric(
                        ...
                        child: Text(Language.getProductStrings("shippingSection.form.free.label"),style: TextStyle(fontSize: AppStyle.fontSizeTabContent()),)),
                    Switch(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Container(
                        ...
                        height: Measurements.height *
                            (widget.parts.isTablet ? 0.05 : 0.07),
                        child: Text(Language.getProductStrings("shippingSection.form.general.label"),style: TextStyle(fontSize: AppStyle.fontSizeTabContent()),)),
                    Switch(
                      activeColor: widget.parts.switchColor,
