            ...
            Container(
              child: InkWell(
                ...
                child: Container(
                    ...
                    child: Center(
                        child: Text(
                      Language.getProductStrings("variantEditor.add_variant"),style: prefix0.TextStyle(fontSize: AppStyle.fontSizeTabContent()),
                    ))),
                onTap: () {
                  Navigator.push(
                    context,
                                          ...
                                          child: Row(
                                            mainAxisAlignment:
                                                MainAxisAlignment
                                                    .spaceAround,
                                            children: <Widget>[
                                              Container(child: AutoSizeText(Language.getProductStrings("price.sale"),style: TextStyle(fontSize: AppStyle.fontSizeTabContent()))),
                                              Switch(
