...
class _VariantPopUpState extends State<VariantPopUp> {
  ...
  initState() {
    ...
    api.getInventory(
      ...
      widget.textEditingController = TextEditingController(text:(widget.parts.editMode?(inventory.stock?.toString()??"0"):"0"));
      setState(() {});
    });
  }
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          prefixIcon: IconButton(
                                            ...
                                            onPressed: () {
                                              setState(() {
                                                if (num.parse(widget.textEditingController.text) > 0)
                                                  widget.textEditingController.text = (num.parse(widget.textEditingController.text)-1).toString();
                                              });
                                            },
                                          ),
