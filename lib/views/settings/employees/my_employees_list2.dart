...
class MyEmployeesList2 extends StatefulWidget {
  @override
  createState() => _MyEmployeesListState2();
}

class _MyEmployeesListState2 extends State<MyEmployeesList2> {
  StreamController _employeesController;
  final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();

  int count = 1;

  Future<dynamic> fetchPost([howMany = 5]) async {
