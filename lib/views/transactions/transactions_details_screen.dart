...
//          );
  ...
  Widget orderRowBody() {
    ...
    int no = parts.currentTransaction.details.application_no == null ? 0 : 1;
    int number =
        parts.currentTransaction.details.application_number == null ? 0 : 1;
    int finance = parts.currentTransaction.details.finance_id == null ? 0 : 1;
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              parts.currentTransaction.details.reference != null
                  ...
                  : Container(),
              parts.currentTransaction.details.pan_id != null
                  ? Container(
                      alignment: Alignment.centerLeft,
                      height: Measurements.height * getCustomNumber(0.05, 0.05),
                      child: RichText(
                          ...
                          text: TextSpan(
                              ...
                              children: [
                                ...
                                TextSpan(
                                  text:
                                      '${parts.currentTransaction.details.pan_id}',
                                ),
                              ])),
                    )
                  : Container(),
              parts.currentTransaction.details.application_no != null
                  ? Container(
                      alignment: Alignment.centerLeft,
                      height: Measurements.height * getCustomNumber(0.05, 0.05),
                      child: RichText(
                          ...
                          text: TextSpan(
                              ...
                              children: [
                                ...
                                TextSpan(
                                  text:
                                      '${parts.currentTransaction.details.application_no}',
                                ),
                              ])),
                    )
                  : Container(),
              parts.currentTransaction.details.application_number != null
                  ? Container(
                      alignment: Alignment.centerLeft,
                      height: Measurements.height * getCustomNumber(0.05, 0.05),
                      child: RichText(
                          ...
                          text: TextSpan(
                              ...
                              children: [
                                ...
                                TextSpan(
                                  text:
                                      '${parts.currentTransaction.details.application_number}',
                                ),
                              ])),
                    )
                  : Container(),
              parts.currentTransaction.details.finance_id != null
                  ? Container(
                      alignment: Alignment.centerLeft,
                      height: Measurements.height * getCustomNumber(0.05, 0.05),
                      child: RichText(
                          ...
                          text: TextSpan(
                              ...
                              children: [
                                ...
                                TextSpan(
                                  text:
                                      '${parts.currentTransaction.details.finance_id}',
                                ),
                              ])),
                    )
                  : Container(),
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                Flexible(
                  child: Container(
                      height: Measurements.height * getCustomNumber(0.04, 0.06),
                      alignment: Alignment.centerLeft,
                      child: AutoSizeText(
              ...
              children: <Widget>[
                Flexible(
                  child: Container(
                    padding: EdgeInsets.all(1),
                    alignment: Alignment.centerLeft,
                    height: Measurements.height * getCustomNumber(0.015, 0.03),
                    child: RichText(
                        maxLines: 2,
                        text: TextSpan(
                            style: TextStyle(
      ...
      child: Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return Container(
              child: Container(
                height: Measurements.height * getCustomNumber(0.015, 0.04),
                child: Row(
                  children: <Widget>[
                    Text(
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: Measurements.width * 0.02),
                    ),
                    AutoSizeText(
