...
class TransactionDetailsScreen2 extends StatefulWidget {
  TransactionDetails currentTransaction;
  ScreenParts2 parts;
  String _wallpaper;
  TransactionDetailsScreen2(this.currentTransaction,this._wallpaper);
  ...
  @override
  _TransactionDetailsState2 createState() => _TransactionDetailsState2();
}


class _TransactionDetailsState2 extends State<TransactionDetailsScreen2> {
  
  @override
  void initState() {
    super.initState();
    print("start init");
    widget.parts = ScreenParts2();
